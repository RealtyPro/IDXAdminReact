...
export default function PropertyEditPage() {
  const [property, setProperty] = useState<typeof mockProperties[0] | undefined>(undefined);
        ...
        <CardContent className="space-y-4">
          <form className="space-y-4">
            ...
            <div>
              ...
              <textarea id="description" className="w-full min-h-[100px] rounded-md border border-input bg-background px-3 py-2 text-sm" defaultValue={property.description} />
            </div>
